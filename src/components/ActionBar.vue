...
const showBuildMonumentMessage = computed(() => currentActionType.value === actionTypes.buildMonument)
const showBuildMonumentMultipleMessage = computed(() => currentActionType.value === actionTypes.buildMonumentMultiple)
const showSwapTilesMessage = computed(() => currentActionType.value === actionTypes.swapTiles)
const showRevoltAttackMessage = computed(() => 
  conflictType.value === conflictTypes.revolt && currentActionType.value === actionTypes.conflictAttack
)
const showRevoltDefendMessage = computed(() => 
  conflictType.value === conflictTypes.revolt && currentActionType.value === actionTypes.conflictDefend
)
const showWarAttackMessage = computed(() => 
  conflictType.value === conflictTypes.war && currentActionType.value === actionTypes.conflictAttack
)
const showWarDefendMessage = computed(() => 
  conflictType.value === conflictTypes.war && currentActionType.value === actionTypes.conflictDefend
)
const showWarChooseLeaderMessage = computed(() => currentActionType.value === actionTypes.conflictChooseLeader)
